...
$profile = $authController->getJobSeekerProfile(Session::getUserId());

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $data = [
        'jobseeker_id' => Session::getUserId(),
        'full_name' => Validator::sanitize($_POST['full_name']),
        'contact' => Validator::sanitize($_POST['contact'])
    ];

    if ($authController->updateJobSeekerProfile($data)) {
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title">Profil Pencari Kerja</h3>
